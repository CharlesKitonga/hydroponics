	...
	<div>
		<div class="container">
			<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20 col-md-6">
                ...
                <div class="space">
                    <Input type="email" v-model="data.email" placeholder="Email address..." required/>
                </div>

                <div class="space">
                    <Input type="password" v-model="data.password"  placeholder="Password...(if you still remember :)" required/>
                </div>
    ...
    export default{
        ...
        methods: {
        	async login(){
	            ...
	            if (this.data.password.length < 8) return this.e('Incorrect Login Details')
	            this.isLogging = true
